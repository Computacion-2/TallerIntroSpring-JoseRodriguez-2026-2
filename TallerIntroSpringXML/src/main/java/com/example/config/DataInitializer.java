...
public class DataInitializer {
    ...
    public void init() {
        ...
        // Karol G (5)
        createTrack("TRK-026", "TQG", "Reggaeton", 199, "Manana Sera Bonito", List.of(a6.getId(), a1.getId())); // Colaboracion Karol G & Shakira
        ...
        createTrack("TRK-039", "Con Altura", "Reggaeton", 161, "Con Altura", List.of(a8.getId(), a2.getId())); // Colaboracion Rosalia & Bad Bunny / J Balvin
