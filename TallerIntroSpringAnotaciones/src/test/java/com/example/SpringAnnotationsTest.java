...
public class SpringAnnotationsTest {
    ...
    @Test
    public void testSpringAnnotationsConfiguration() {
        // Cargar el contenedor de Spring escaneando componentes por anotaciones (@Repository, @Service, @Component)
        ApplicationContext context = new ClassPathXmlApplicationContext("applicationContext.xml");

        // Obtener los beans inyectados mediante anotaciones
